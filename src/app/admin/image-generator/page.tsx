...
import LeonardoImageGenerator from "@/components/LeonardoImageGenerator";
import { requireAdminSession } from "@/lib/admin-auth";

export const metadata: Metadata = {
  title: "Image Generator",
  description: "Private Vanta Orbit Media Leonardo image generator.",
};
        ...
        <div className="flex flex-col gap-6 rounded-[2rem] border border-white/10 bg-black/55 p-6 shadow-[0_0_55px_rgba(124,58,237,0.18)] backdrop-blur-xl sm:flex-row sm:items-end sm:justify-between sm:p-8">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-300 sm:text-base">
              Generate Leonardo images from the private admin workspace without exposing the API key to the browser.
            </p>
          </div>
          <AdminLogoutButton />
        </div>
