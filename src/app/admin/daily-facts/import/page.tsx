...
import AdminDailyFactsImport from "@/components/AdminDailyFactsImport";
...
export const metadata: Metadata = {
  title: "Import Daily Space Facts",
  description: "Import Daily Space Facts JSON into Supabase.",
};

export default async function AdminDailyFactsImportPage() {
        ...
        <div className="flex flex-col gap-6 rounded-[2rem] border border-white/10 bg-black/55 p-6 shadow-[0_0_55px_rgba(124,58,237,0.18)] backdrop-blur-xl sm:flex-row sm:items-end sm:justify-between sm:p-8">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-300 sm:text-base">
              Paste a full-year JSON pack, validate it, and import it idempotently into Supabase.
            </p>
          </div>
          <AdminLogoutButton />
        </div>
